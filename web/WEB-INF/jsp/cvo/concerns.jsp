...
<logic:iterate id="concern" name="concerns">
			<div id="concernId${concern.id}">
						<logic:notEqual name="type" value="0">
							<span class="participantName"><b><a href="userProfile${concern.id}.jsp"><bean:write name="concern" property="author.firstname" /></b></a>&nbsp;said:</span>
							<br>
						</logic:notEqual>
						...
						<logic:equal name="type" value="0">
						<div id=actionMenu class="actionMenu">Actions: <a href="javascript:editConcernPopup(${concern.id}, '${concern.content}');">edit concern</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:editTagsPopup('${concern.id}');">edit tags</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:delConcern(${concern.id});">delete entire concern</a></div>
						<br>
						</logic:equal>
			</div>
	<p></p>
