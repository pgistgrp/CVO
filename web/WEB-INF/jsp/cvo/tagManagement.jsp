...
function ifEnter(field,event) { var theCode = event.keyCode ? event.keyCode : event.which
? event.which : event.charCode; if (theCode == 13){ prepareConcern(); $('theTag').focus();
return false; } else return true; } function showTheError(errorString, exception){
$('overview').style.display = 'none'; $('slate').style.display = 'none'; $('bar').style.display
...
<div id="container">
	<div id="searchNavContiner">
		...
		<div id="mainNav" class="navigation">Home&nbsp;&nbsp;&nbsp;&nbsp;<span class="active">Current
				Task</span>&nbsp;&nbsp;&nbsp;&nbsp;Discussion&nbsp;&nbsp;&nbsp;&nbsp;Maps&nbsp;&nbsp;&nbsp;&nbsp;Library&nbsp;&nbsp;</div>
	</div>
	<!-- LIGHTBOX -->
	<div id="overlay"></div>
	<div id="lightbox"></div>
