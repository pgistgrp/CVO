...
<br>
<span class="title_section">Viewing Keywords/phrases:</span>
<logic:iterate id="concern" name="concerns">
			<div id="concernId${concern.id}" class="theConcern">
						...
						<logic:equal name="type" value="0">
						<div id=actionMenu class="actionMenu">Actions: <a href="javascript:editConcernPopup(${concern.id});">edit concern</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:editTagsPopup('${concern.id}');">edit keywords </a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:delConcern(${concern.id});">delete entire concern</a></div>
						<br>
						</logic:equal>
			</div>
	<p></p>
