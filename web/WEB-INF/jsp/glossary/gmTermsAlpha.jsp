  ...
  <bean:define id="storeInitial" value="" />
	 ...
	 <c:choose>
		...
		<c:otherwise>
		  ...
		  <td style="text-align: center"><a id="edit${term.name}" href="#edit${term.name}" onclick='openEditBox(${term.id}); return false;'>edit</a>&nbsp;|&nbsp;<a href='javascript:deleteConfirm("${term.name}",${term.id});'>del</a></td>
	    </tr>
		<tr>
