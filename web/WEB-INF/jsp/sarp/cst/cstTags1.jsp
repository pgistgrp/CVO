...
<ul>
    ...
    <pg:show condition="${(user.id==baseuser.id && !cst.closed) || modtool}">
		<li id="tag${tag.id}" style="list-style: none;">[<a href="javascript:relateTag(${tag.id});"><strong>&larr;</strong></a>]&nbsp;<a href="javascript:getConcerns(${tag.id});">${fn:escapeXml(tag.tag.name)}</a></li>
    </pg:show>
