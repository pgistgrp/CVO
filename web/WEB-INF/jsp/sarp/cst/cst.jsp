...
<!--    <p><a href="userhome.do?workflowId=${requestScope['org.pgist.wfengine.WORKFLOW_ID']}">Back to Moderator Control Panel</a></p> -->
    ...
    <pg:show condition="${cst.closed}">  
      ...
      <img src="images/vccWorkflowStep2.png" width="112" height="232" style="float:right; margin: 0 0 15px 15px; height: 247px;">
      ...
      <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id="><br>
					Select from the set of keywords and keyphrases of the previous step to create "indicator labels." 
					Make as many labels as you feel appropriate for your concerns, regarding either 
					a) a changing climate condition OR b) a place or thing actually being impacted.
      ...
      <ol id="hiddenRM" style="display:none">
        <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">  <li>Review the list of keywords/phrases in the right-hand column. We are looking for good labels to characterize subsets of concern keywords and keyphrases that emphasize either a climate condition or a place or thing being impacted. Remember to use keyword/phrases developed by everyone and not just your own.</li>
						<li>Enter an indicator label by typing into the textbox at the top of the left-hand column. Note that typing numbers and punctuation in labels will be ignored. The indicator label you type can be a new word or a phrase, or it could be the same as keywords and/or phrases in the right column, you choose. Hit enter. Then, click on that label to activate it. </li>
						...
						<li>You can remove a keyword from a category by clicking on the arrow in center column which points to the right.  Note that we want you to cluster just the keyphrases you think are similar to the indicator label you typed. We ARE interested in identifying the most representative labels for a common set of keywords/phrases, and ARE NOT interested in just general labels. Making general labels is the opposite of what we seek in the sense that we want you to specify the climate change condition OR the place or thing being impacted. Note that in Step 4 we will assign units of measure to these indicator labels.</li>
						<li>Complete instructions 1-4 as many times as you think to develop indicator labels until you are satisfied.</li>
