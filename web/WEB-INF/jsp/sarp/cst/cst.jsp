...
<!--    <p><a href="userhome.do?workflowId=${requestScope['org.pgist.wfengine.WORKFLOW_ID']}">Back to Moderator Control Panel</a></p> -->
    ...
    <div id="overview" class="box2">
      ...
      <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">This is the “Concern category tool” section of the site. You have <strong>three</strong> tasks. Expected total time to complete this tool is 40 minutes spread over four days.</pg:termHighlight>
      <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">If you had to put some of your favorite concern keywords/phrases into a category of five words or less, what would they be? Your </strong>first task</strong> is to create at least three different categories and then put the keywords/phrases you are most interested in into those categories. You may want to go back to the “Brainstorm concerns tool” again to help you find your favorite keywords/keyphrases. You must hit “Publish” to save your categories. After everyone is finished publishing their categories, your <strong>second task</strong> is to post a comment asking others to vote on your categories of keywords/phrases. Whenever you are finished voting and commenting with others, your <strong>third task</strong> is to see how people voted or commented about your own categories, and then modify your categories if you choose.</pg:termHighlight>
      <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">Please click “<strong>Read More</strong>” below to see how to use the “Categorize concern keywords/phrases” tool to create and publish categories, comment and vote on other’s categories, and finally, delete or rename your categories.</pg:termHighlight>
      <p>
      ...
      <p id="hiddenRM" style="display:none">
        <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id="><i>Task one: Add and publish your categories (Suggested time to complete: 10 minutes).</i> Remember that you can go back to the “Brainstorm concerns tool” anytime to filter down the personal keywords/phrases into just those you were most interested in using. Try to use not just your own keywords/keyphrases but others as well. Create at least three categories of concern. </pg:termHighlight>
	<pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">Come up with a name for a category of concern keywords/phrases in five words or less. For instance, you may want to put the keywords/phrases “paying more for my insurance because of risk of coastal erosion” and “making expensive repairs to my home because of coastal erosion” into one more general category called “Costs of coastal erosion.” To create a concern category, type in a name into the textbox under the title “Categorize concern keywords/phrases” and hit “Add Category.” The category will appear in the left column. To add a description of your category, select and highlight a category and then type into the text box at the bottom of the left column. To save your description you must hit the “save description” button. To put your favorite concern keywords/phrases into a category, you must first select and highlight the category in the far left column. Then go to the “Keywords” tab in the far right column. To add a keyword/phrase, click the little arrow “ß” symbol and it will be added to the middle column under the title “Keywords within …” your category name. To take a keyword/keyphrase back out of a category, select and highlight a category in the far left column then click the little arrow symbol “à” next to the keyword/keyphrase in the middle column. When you are ready to let others see your categories, and to save your categories, you must hit the “Publish” button.</pg:termHighlight>
	<pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id="><i>Task two: Post a comment about your categories for a vote by others (Suggested time to complete: 20 minutes).</i> Your second task is to post a comment about your categories and then vote on other’s comments. Vote on whether you agree or not with someone else’s categories of keywords/keyphrases. Vote as often as you can. Try to vote on at least three other comments, if not more.</pg:termHighlight>
	<pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id="><i>Task three: Rename or delete your own categories (Suggested time to complete: 10 minutes).</i> After looking at other’s votes or comments about your concern, you have the option of modifying the names of your original categories and the keywords/phrases inside them. First, you must click on and highlight a concern category. At the bottom of the “Categorize concern keywords/phrases” box are two editing tools next to “Editing Options:”. To rename your categories, click “Rename,” enter a new name in the “Rename to:” box, and then hit the “Modify” button. To permanently delete a concern category, click the “Delete” button.</pg:termHighlight>
      </p>
    </div>
