...
<!--    <p><a href="userhome.do?workflowId=${requestScope['org.pgist.wfengine.WORKFLOW_ID']}">Back to Moderator Control Panel</a></p> -->
    ...
    <div id="overview" class="box2">
      ...
      <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">This is the “Concern category tool” section of the site. Expected total time to complete this tool is 40 minutes spread over four days.
      ...
      <p id="hiddenRM" style="display:none">
        <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id="><i>Add and publish categories (Suggested time to complete: 10 minutes).</i> Remember that you can review results of the "Brainstorm concerns tool" anytime. Try to use not just your own keywords/keyphrases but others as well.
	...
	<br><br><i>Post a comment about your categories for a vote by others (Suggested time to complete: 20 minutes).</i> Your second task is to post a comment about your categories and then vote on other’s comments. Vote on whether you agree or not with someone else’s categories of keywords/keyphrases. Vote as often as you can. Try to vote on at least three other comments, if not more.
      </p>
    </div>
