						...
						<div class="discussionRow">
							<c:choose>
								...
								<div class="discussionBody">
									...
									<h4 id="discussionAuthor">- <pg:url page="/publicprofile.do" target="_blank" params="userId=${concern.author.id}">${concern.author.loginname}</pg:url> on ${concern.createTime.month}</h4>
