...
<body>
  ...
  <div id="container">
	...
	<br><br><i>Task two: Filter and deliberate about other’s concern keywords/phrases (Suggested time to complete: 20 minutes).</i> Your second task is to filter down concern keywords/phrases to the ones you are most interested in, vote on them, and then provide comments to others. Vote as often as you can. Try to make comments on at least three other concerns, if not more. If someone comments on your concern, reply back to them and get a discussion going. To filter everyone else’s keywords/phrases, there are three different tools on the toolbar just above all the concerns. On the far left tool, you can enter a word into “Search concerns:” and search all keywords. In the middle tool, you can click “Browse keywords” in alphabetical order. In the far right tool, you can sort concerns and keyphrases in several different ways: by date added; by vote; and finally, by comments. To make a comment, click on “Comments,” which will take you to a new window.<br><br>
