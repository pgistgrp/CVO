...
<body>
  ...
  <div id="container">
    ...
    <div id="overview" class="box2">
      ...
      <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">This is the “Brainstorm concern tool” section of the site. You have <strong>three</strong> tasks. Expected total time to complete this tool is 40 minutes spread over four days.<br>
      If you had the chance to tell someone your personal concerns about the regional impacts of global climate change on the Oregon coast, in 10 words or less, what would you say? Your <strong>first task</strong> is to try to boil down at least three different personal concerns into keywords/phrases. Only these keywords/phrases will be used later on. After everyone is finished entering their keyword/phrases, your <strong>second task</strong> is to filter down what others said. Filter other’s keywords/phrases down to those you are most interested in and vote or comment as many times as possible. Try to vote or comment on at least three other concerns. Whenever you are finished filtering and deliberating with others, your <strong>third task</strong> is to see if anyone voted or commented on your own keywords/phrases. Modify your keywords/phrases if you choose.
      <br>Please click “<strong>Read More</strong>” below to see how to use the “Brainstorm concern tool” to submit keywords/phrases, filter and deliberate about keywords/phrases, and modify your original concern keywords/phrases.</pg:termHighlight>
      <p>
      ...
      <p id="hiddenRM" style="display:none">
        <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">Task one: Add your own keywords or keyphrases (Suggested time to complete: 10 minutes). Consider a short but specific and personal concern keyword or keyphrase. For example, instead of just saying “coastal erosion,” you might say “paying more for my insurance because of risk of coastal erosion.” See the “Learn More” section of the VCC website for a list of possible coastal impacts of regional climate change. Remember that only your concern keywords/phrases will be used later on. Whatever you write as a concern is just an additional explanation about your keywords/phrases, provided to others to help them understand your concern. The system offers you “Previously suggested keywords/keyphrases,” which you can select using the checkboxes. However, we strongly suggest that you type in your own specific and personal 10 word or less concern keyphrase into the box labeled “Add Keyphrase.”
	<br><br>Task two: Filter and deliberate about other’s concern keywords/phrases (Suggested time to complete: 20 minutes). We expect at least 100 people could be participating, representing counties all along the Oregon coast. If 100 people type in at least three concern keywords or keyphrases of 10 words or less, that means over 300 concerns to go through. Your second task is to filter down concern keywords/phrases to just the ones you are most interested in, vote on them, and then provide comments to others. Vote as often as you can. Try to make comments on at least three other concerns, if not more. If someone comments on your concern, reply back to them and get a discussion going. To filter everyone else’s keywords/phrases, there are three different tools on the toolbar just above all the concerns. On the far left tool, you can enter a word into “Search concerns:” and search all keywords. In the middle tool, you can click “Browse keywords” in alphabetical order. In the far right tool, you can sort concerns and keyphrases in several different ways: by date added (newest to oldest, oldest to newest); by vote (most agreement, least agreement, most votes); and finally, by comments (most comments, most views). Once you have filtered down concern keywords/phrases of most interest to you, voted to agree or disagree, made comments, and replied to comments made on your concerns by others. To make a comment, click on “Comments,” which will take you to a new window.<br><br>
	Task three: Re-evaluate your own concern keywords/phrases (Suggested time to complete: 10 minutes). To filter only your own keywords/phrases and see if you have any comments yet, click the checkbox underneath “All participant’s concerns” labeled “Show only my concerns.” Look at see how many people voted to agree or disagree with your concern. Click on the “Comments” link to read other’s comments. After looking at other’s votes and comments on your concern, you have the option of modifying your original concern keywords/phrases or the text of your concern. To edit your concern keywords, click “Edit keywords” and enter a new keyword or keyphrase. You can delete a previous concern keyword or keyphrase by unchecking the box next to it. You will still need at least two keyphrases. Remember that only keywords/phrases will be used later on. To edit whatever you typed in to explain your concern, click “Edit concern,” edit the text, then click “Submit Edits!” To permanently delete a concern, click “Delete concern.” Your original concern keywords/phrases will not be deleted.</pg:termHighlight>
      </p>
    </div>
    <a name="filterJump"></a>
