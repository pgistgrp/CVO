...
<body>
  ...
  <div id="container">
    ...
    <div id="overview" class="box2">
      ...
      <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">This is the “Brainstorm concern tool” section of the site. You have <strong>three</strong> tasks. Expected total time to complete this tool is 40 minutes spread over four days.<br><br>
