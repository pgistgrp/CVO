			...
			<div id="discussion${comment.id}" class="drtComment">
				<div class="drtComment">
						...
						<div id="discussionText${comment.id}" class="discussionText peekaboobugfix">
							<p>${comment.content}</p>
							<h3>- <pg:url page="/publicprofile.do" target="_blank" params="userId=${pg:purify(comment.author.id)}">${pg:purify(comment.author.loginname)}</pg:url> at ${comment.createTime}</h3>
						</div>
