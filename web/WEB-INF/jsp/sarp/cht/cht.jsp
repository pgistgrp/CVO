...
<div id="container">
  <div id="cont-resize">
	...
	<div id="overview" class="box2">
      ...
      <p><pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">This is the “Category hierarchy tool” section of the site. You have <strong>three</strong> tasks. Expected total time to complete this tool is 40 minutes spread over four days.</pg:termHighlight></p>
      <p><pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">Can you make your favorite categories more specific, by adding other categories underneath them in a hierarchy? Your <strong>first task</strong> is to create at least three hierarchies of concern categories, by trying to put a more specific category under your favorite categories. You must hit “Publish” to save your hierarchies. You will not be able to modify them after you publish. After everyone is finished publishing their hierarchies of categories, your <strong>second task</strong> is to post a comment asking others to vote on your hierarchies. Whenever you are finished voting and commenting with others, your <strong>third task</strong> is to see how people voted or commented about your hierarchies, and then as a group you have the option of asking the moderator to create a new hierarchy.</pg:termHighlight></p>
      <p><pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">Please click “<strong>Read More</strong>” below to see how to use the “Category hierarchy tool” to create and publish hierarchies, comment and vote on other’s hierarchies, and finally, ask the moderator to create a new hierarchy.</pg:termHighlight></p>
      <p>
      ...
      <p id="hiddenRM" style="display:none">
        <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id="><i>Task one: Add and publish your hierarchies (Suggested time to complete: 10 minutes).</i> Create at least three hierarchies of concern categories by adding a more specific category under your favorite categories. If you feel your favorite categories are already the most specific you can find, and then try to put them under more general categories. You may choose to create a long hierarchy that ends very specific and begins very general, or a short one that ends very specific and starts a little less specific. To create a category hierarchy, first select and highlight a concern category label in the left column and add it by clicking the “+” button under the label “Create category hierarchies.” To remove a category click the “-“ button. To put a more specific concern category under a more general one, select and highlight your favorite specific concern category and use the little arrow button to position it underneath and to the right of a more general concern category. When finished to share with others, click the "Publish" button at the bottom of left column. You will not be able to edit your hierarchies after you “Publish.”<br><br>
	<i>Task two: Post a comment about your hierarchies for a vote by others (Suggested time to complete: 20 minutes).</i> Your second task is to post a comment about how you made your hierarchies and then vote on other’s comments. Vote on whether you agree or not that someone else’s hierarchy of concern categories is specific enough. Vote as often as you can. Try to vote on at least three other comments, if not more.<br><br>
	<i>Task three: Request as a group that the moderator create a new hierarchy (Suggested time to complete: 10 minutes).</i> You are not able to modify or delete your hierarchies individually, but you can ask the moderator as a group to create a new hierarchy.</pg:termHighlight>
      </p>
    </div>
