...
<div id="container">
  <div id="cont-resize">
	...
	<div id="overview" class="box2">
      ...
      <p><pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">Participants arrange the concern category labels into hierarchies, from general (left-most category) to more specific (right-most category). This helps identify indicator variables, used for creating map displays of climate concerns, in a later step. </pg:termHighlight></p>
      <p><pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">To start... click on a concern category label in the left column. Clicking on an arrow at the top of the left column will move the label in the direction of the arrow. Category labels can be ordered 'top to bottom' and 'left to right' (or reverse as you choose). All labels at the left-most side of the column are 'top level' for that category label. Any label set to the right of an immediate higher label with be a sublabel (subcategory). </pg:termHighlight><pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">This arranging of category label, subcategory label, and if </pg:termHighlight><pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">appropriate, sub-subcategory etcetera labels, forms hierarchies. Labels at the left-most side of column and toward the top of list are considered more important. </pg:termHighlight></p>
      <p><pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">Note there is a line that splits the window into a top and bottom panes.  With a category label highlighted, clicking on a minus sign will move a label (and sub-labels) to the bottom pane (out of consideration). Highlighting a label in the bottom window and clicking plus will add it to the top pane. Only, labels in the top pane will move forward to next step. </pg:termHighlight></p>
      <p><pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">Repeat the above  as many times as is appropriate to form hierarchies. When finished to share with others, click the "Publish" button at the bottom of left column.</pg:termHighlight></p>
      <p>
      ...
      <p id="hiddenRM" style="display:none">
        <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">Hierarchies provide a way to construct 'paths to indicators'; that is, a path from general concerns to specific concerns.  More specific concern categories (right-most labels) form the basis for identifying indicator measurements of climate change/variability, to be addressed in the next step.</pg:termHighlight>
      </p>
    </div>
