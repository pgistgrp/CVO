...
<div id="container">
  <div id="cont-resize">
	...
	<div id="overview" class="box2">
      ...
      <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id=">This is the “Concern indicator tool” section of the site. You have <strong>three</strong> tasks. Expected total time to complete this tool is 40 minutes spread over four days.
      <br><br>Can you suggest how you would actually measure the most specific aspects of a concern hierarchy? Your <strong>first task</strong> is to select your favorite hierarchies of concern categories, select the most specific keyword/phrase within them, and then suggest the best way to measure it. The result is an indicator. You must hit “Publish” to save your indicators. After everyone is finished publishing their hierarchies of categories, your <strong>second task</strong> is to post a comment and vote on other’s comments. Whenever you are finished voting and commenting with others, your <strong>third task</strong> is to see how people voted or commented about your indicators, and then modify your indicators if you choose.
      <br><br>Please click “<strong>Read More</strong>” below to see how to use the “Concern indicator tool” to create and publish indicators, comment and vote on other’s indicators, and finally, modify your indicators.</pg:termHighlight>
      <p>
      ...
      <p id="hiddenRM" style="display:none">
        <pg:termHighlight styleClass="glossHighlight" url="glossaryView.do?id="><i>Task one: Add and publish your indicators (Suggested time to complete: 10 minutes).</i> Suggest how you would measure the most specific aspects of a concern hierarchy for at least three hierarchies and as many as possible. To create an indicator, first select and highlight a hierarchy label in the left column. In the middle column, select the most specific keyword/phrase from the pull down box or even enter your own keyword/keyphrase. Then suggest how you would measure that specific keyword/keyphrase by entering a unit of measurement and creating a potential indicator. You can select, highlight and modify your indicators at any time. Indicators will be used to create climate vulnerability maps using data as it becomes available from the Oregon Coastal Atlas data archive. When finished to share with others, click the "Publish" button at the bottom of left column. Your indicators will be listed on the right column. You will not be able to edit your hierarchies after you “Publish.”
	<br><br><i>Task two: Post a comment about your indicators for a vote by others (Suggested time to complete: 20 minutes).</i> Your second task is to post a comment about how you selected the most specific keywords/phrases and suggested the best way to measure it, and also vote on other people’s comments. Vote as often as you can.
	<br><br><i>Task three: Modify your indicators (Suggested time to complete: 10 minutes).</i> After looking at other’s votes or comments about your concern, you have the option of modifying your indicators.</pg:termHighlight>
      </p>
    </div>
