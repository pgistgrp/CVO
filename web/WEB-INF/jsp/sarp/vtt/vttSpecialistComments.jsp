...
<c:choose>
				...
				<div class="drtComment">
						...
						<div id="voting-comment${comment.id}" class="discussionVoting">
							...
							<c:choose>
								...
								<c:otherwise>
									<a href="javascript:setVoteOnComment(${comment.id}, 'false');"><img src="/images/btn_thumbsdown.png" alt="I disagree!" border="0"/></a> 
									<a href="javascript:setVoteOnComment(${comment.id}, 'true');"><img src="/images/btn_thumbsup.png" alt="I agree!" border="0"/></a>
								</c:otherwise>
							</c:choose>
						</div>
						...
						<div id="discussionText${comment.id}" class="discussionText peekaboobugfix">
							<p>${comment.content}</p>
							<h3>- <pg:url page="/publicprofile.do" target="_blank" params="userId=${comment.author.id}">${comment.author.loginname}</pg:url> at ${conern.createTime}</h3>
						</div>
    ...
    <div class="pagination discussion-left">
      ...
      <logic:notEqual name="setting" property="page" value="1">	
        <a href="javascript:getComments(${setting.page - 1});"><img src="images/btn_prev_a.gif" alt="Prev" name="prev" class="button" id="prev" onMouseOver="MM_swapImage('prev','','images/btn_prev_b.gif',1)" onMouseOut="MM_swapImgRestore()"></a>
      </logic:notEqual>
      ...
      <logic:notEqual name="setting" property="page" value="${setting.pageSize}">	
        <a href="javascript:getComments(${setting.page + 1});"><img src="images/btn_next_a.gif" alt="Next" name="next" class="button" id="next" onMouseOver="MM_swapImage('next','','images/btn_next_b.gif',1)" onMouseOut="MM_swapImgRestore()"></a-->
      </logic:notEqual>
    </div>
