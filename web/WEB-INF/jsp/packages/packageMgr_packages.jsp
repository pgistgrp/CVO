...
<table border="0" cellspacing="0" width="100%" class="box12">
	...
	<c:forEach var="package" items="${packages}" varStatus="loop">
		<tr>
			<td class="col1"><a target="_blank" href="package.do?pkgId=${package.id}&fundSuiteId=${fundSuiteId}&projSuiteId=${projSuiteId}&critSuiteId=${critSuiteId}&pkgSuiteId=${pkgSuiteId}">Package ${package.id}</a></td>
