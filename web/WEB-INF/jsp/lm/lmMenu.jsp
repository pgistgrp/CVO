...
p.nomargin {margin-left:0px;}
	...
	<div id="container">
		...
		<p>In this section of the website any interested user can link to the <a href="http://www.coastalatlas.net"title="Oregon Coastal Atlas">Oregon Coastal Atlas</a> or learn more about 
		the Voicing Climate Concerns experiment in participatory decision making.
		The entire website will be available to registered participants. <a href="register.do">Register now</a>.</p>
		<!-- Begin explanation -->
	<div id="headerMenu">
		<div id="headerContainer">
			<div id="headerTitle" class="floatLeft">
				...
				<p><i><b>How do I know what to value?</b></i> It is a good question that only you can answer. Value is defined as worth, 
				desirability, or utility based on individual preferences. The total value of any resource is the sum of the values of the
				different individuals involved in the use of the resource (Intergovernmental Panel on Climate Change 2007). Start by thinking about things 
				you know that you value about the Oregon coast. What you value could be based on a personal experience traveling to the coast, 
				or it could be based on what you know about the economic livelihood of your entire community. Also, listen to what other 
				people are saying.</p>
				
				<p><i><b>How do I know whether what I value will could be impacted by regional climate change and variability?</b></i>
				It is also a good question, but probably not something you can answer yourself without good scientific information.
				Look at the section below entitled "Nine Ways that Climate Change and Variability Could Impact What You Value." You might discover that the things you value most are not likely to impacted by climate change and variability. 
				What you value more right now about the Oregon coast might change depending on what you learn about potential future impacts.</p>
				
				<p><i><b>How do I know whether what I value is vulnerable?</b></i> Ask yourself whether you are concerned about regional climate change and variability on the Oregon coast 
				because it impacts what you value most, because it impacts what you think is most vulnerable, or a little of both. Then ask yourself where the vulnerability
				comes from? Are you concerned because it seems what you value is highly exposed to climate change and variability? Are you concerned because it seems what you value is highly sensitive to climate change and variability? 
				Or are you concerned because you do not think that your public agency decision makers, the scientific experts, or others are doing enough to help you deal with the impacts of climate change and variability on what you value?</p>
				...
				<p>Climate <b>variability</b> refers to <b>variations</b> in the mean state and other
				...
				<p>Look at the expected impacts of higher mean temperatures. Will something you value about the Oregon coast be impacted? 
				If so, think of the best indicator to measure the impact specifically on what you value. Consider the other eight impacts below.</p>
