...
#container {font-size:12pt;}
	...
	<!-- #container is the container that wraps around all the main page content -->
	 <div id="container">
 <h3 class="headerColor" style="text-transform:none"><a name="purpose" class="headerColor">What is the purpose of Let's Improve Transportation?</a></h3>
...
<p>Let's Improve Transportation is a website that has been
	...
	in this process.</p>
<h3><a name="step1" class="headerColor">Step 1: Discuss Concerns</a></h3>
    ...
    <h3><a name="step2" class="headerColor">Step 2: Review Criteria</a></h3>
    ...
    <h3><a name="step3" class="headerColor">Step 3: Create Packages</a></h3>
    ...
    <h3><a name="step4" class="headerColor">Step 4: Evaluate Packages</a></h3>
    ...
    <h3><a name="step5" class="headerColor">Step 5: Prepare Group Report</a></h3>
