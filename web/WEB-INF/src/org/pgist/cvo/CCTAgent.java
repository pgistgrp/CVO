...
public class CCTAgent {
     ...
     * @param params A Map contains: <br>
     *         <ul>
     *           <li>page - long int, no special meaning here</li>
     *           <li>pagenumber - A string, the page that JSP selects. </li>
     *         </ul>
     * @return A Map contains: <br>
     *         <ul>
     *           <li>successful - a boolean value denoting if the operation succeeds</li>
     *           <li>html - a HTML source segment. (valid when count>0) <br>
     *                  (Generated by /WEB-INF/jsp/cvo/getStopWords.jsp)<br>
     *                  The following variables are available for use in the jsp, stored in request:
     *                  <ul>
     *                    <li>cctForm - A CCTForm object stroring the requested stopWords list and setting object</li>
     *                  </ul>
     *           </li>
     *           <li>reason - reason why operation failed (valid when successful==false)</li>
     *         </ul>
