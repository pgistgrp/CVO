...
public class PackageAgent {
     ...
     *     <li>reason - reason why operation failed (valid when successful==false)</li>
     *     <li>
     *       html - string, html source segment generated by "/WEB-INF/jsp/packages/packageMgr_packages.jsp". In this page the following variables are avaiable:<br>
     *         <ul>
     ...
     *     <li>reason - reason why operation failed (valid when successful==false)</li>
     *     <li>
     *       html - string, html source segment generated by "/WEB-INF/jsp/packages/packageMgr_manualPackages.jsp". In this page the following variables are avaiable:<br>
     *         <ul>
     *           <li>packages - a Set of clustered package objects</li>
     *         </ul>
     *     </li>
    ...
    public Map getSummary(HttpServletRequest request, Map params) {
        ...
        try {
            ...
            request.setAttribute("userPkg", userPkg);
     ...
     *     <li>reason - reason why operation failed (valid when successful==false)</li>
     *     <li>
     *       html - string, html source segment generated by
     *         "/WEB-INF/jsp/packages/createPackage_summary.jsp" when userPkg is true; or
     *         "/WEB-INF/jsp/packages/createPackage_clusteredSummary.jsp" when userPkg is fasle.
     *         In these pages the following variables are avaiable:<br>
     *         <ul>
     *           <li>package - a UserPackage or ClusteredPackage object</li>
     *         </ul>
     *     </li>
     *   </ul>
     */
    public Map setProjectToPkg(HttpServletRequest request, Map params) {
        ...
        try {
            ...
            if (userPkg) {
                request.setAttribute("userPkg", pkg);
                map.put("html", WebContextFactory.get().forwardToString("/WEB-INF/jsp/packages/createPackage_summary.jsp"));
            } else {
