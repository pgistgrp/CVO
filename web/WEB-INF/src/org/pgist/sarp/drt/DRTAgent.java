...
public class DRTAgent {
    ...
    /**
     * Get DRT announcements for the given infoobject id.
     * 
     * @param params A map contains:
     *   <ul>
     *     <li>oid - int, id of a InfoObject object</li>
     ...
     *           The following variables are available for use in the jsp:
     *           <ul>
     *             <li>announcements - A list of DRTAnnouncement objects</li>
     *           </ul>
     *     </li>
     *   </ul>
     */
    public Map getAnnouncements(HttpServletRequest request, Map params, Map wfinfo) {
        ...
        try {
            Collection<DRTAnnouncement> announcements = drtService.getAnnouncements(oid);
            
            request.setAttribute("announcements", announcements);
            
            map.put("html", WebContextFactory.get().forwardToString("/WEB-INF/jsp/sarp/drt/drtAnnouncements.jsp"));
            map.put("successful", true);
    ...
    /**
     * Create a DRT Announcement for the given infoobject id.
     * 
     * @param params A map contains:
     *   <ul>
     *     <li>oid - int, id of a InfoObject object</li>
     *     <li>title - string, Announcement title</li>
     *     <li>description - string, Announcement description</li>
     *   </ul>
     * 
     * @param wfinfo A map contains:
     *   <ul>
    ...
    public Map createAnnouncement(HttpServletRequest request, Map params, Map wfinfo) {
        ...
        try {
            ...
            if (title.length()>100) throw new Exception("title can't exceeds 100 chars");
            if (description.length()>8192) throw new Exception("content can't exceeds 8192 chars");
            
            Comment comment = drtService.createAnnouncement(oid, title, description);
     ...
     *           <li>html - a HTML source segment generated by /WEB-INF/jsp/drt/categoryTags.jsp<br>
    ...
    public Map getCategoryTags(HttpServletRequest request, Map params) {
        ...
        try {
            ...
            CategoryReference catRef = cstService.getCategoryReferenceById(categoryId);
            request.setAttribute("catRef", catRef);
            map.put("html", WebContextFactory.get().forwardToString("/WEB-INF/jsp/sarp/drt/categoryTags.jsp"));
            map.put("successful", true);
        } catch (Exception e) {
            e.printStackTrace();
            map.put("reason", e.getMessage());
