...
public class BCTAgent {
     ...
     * SPT implementation
     */
    public Collection getConcernComments(String concernID) {
    	
    	Collection comments = null;
        Long concernId = new Long(concernID);

        
        try {
            
        	//normally handled by ConcernViewAction, assume view occurred when this method called from SPT
        	bctService.increaseViews(concernId);
            ...
            comments = bctService.getConcernComments(concernId, setting);
    ...
    public Map createConcernComment(String concernid, String content, String workflowid) {
        Map map = new HashMap();
        map.put("successful", false);
        
        Long concernId = null;
        
        concernId = new Long(concernid);
