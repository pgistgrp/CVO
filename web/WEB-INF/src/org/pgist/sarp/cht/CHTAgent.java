...
public class CHTAgent {
    ...
    /**
     * Get users of a CategoryPath path.
     * 
     * @param params A map contains:
     *   <ul>
     *     <li>pathId - int, id of the CategoryPath object. Required.</li>
     ...
     *     <li>successful - a boolean value denoting if the operation succeeds</li>
     *     <li>reason - reason why operation failed (valid when successful==false)</li>
     *     <li>html - a HTML source segment. (Generated by /WEB-INF/jsp/sarp/cht/chtPathUsers.jsp)<br>
     *           The following variables are available for use in the jsp:
     *           <ul>
     *             <li>comments - A list of Comment objects</li>
     *             <li>setting - A PageSetting objects</li>
     ...
     *   </ul>
     */
    public Map getPathUsers(HttpServletRequest request, Map params) {
        Map map = new HashMap();
        map.put("successful", false);
        ...
        try {
            CategoryPath path = chtService.getPathById(pathId);
            List<User> users = chtService.getPathUsersByPathId(pathId);
            
            request.setAttribute("path", path);
            request.setAttribute("users", users);
            map.put("html", WebContextFactory.get().forwardToString("/WEB-INF/jsp/sarp/cht/chtPathUsers.jsp"));
