...
public class CSTAgent {
    ...
    public Map getTags(HttpServletRequest request, Map params) {
        ...
        try {
            ...
            if (ref.getBct().getId().longValue()!=bct.getId().longValue()) {
                map.put("reason", "CategoryReference object is not in this BCT object");
                return map;
            }
            ...
            if ("0".equals(type)) {
                tags = cstService.getRealtedTags(bctId, categoryId, setting);
                
                map.put("tags", tags);
            } else if ("1".equals(type)) {
                tags = cstService.getUnrelatedTags(bctId, categoryId, setting);
                ...
                Collection orphanTags = cstService.getOrphanTags(bctId, orphanSetting);
    ...
    public Map getOrphanTags(HttpServletRequest request, Map params) {
        ...
        try {
            ...
            Collection tags = cstService.getOrphanTags(bctId, setting);
    ...
    public Map addCategory(Map params) {
        ...
        try {
            ...
            CategoryReference newCat = cstService.addCategoryReference(bctId, parentId, name);
    ...
    public Map moveCategory(Map params) {
        ...
        try {
            cstService.moveCategoryReference(bctId, parent0Id, parent1Id, categoryId);
            map.put("successful", true);
        } catch(Exception e) {
            e.printStackTrace();
            map.put("reason", e.getMessage());
    ...
    public Map editCategory(Map params) {
        ...
        try {
            ...
            cstService.editCategoryReference(bctId, categoryId, name);
            map.put("successful", true);
        } catch(Exception e) {
            e.printStackTrace();
            map.put("reason", e.getMessage());
    ...
    /**
     * Delete the specified CategoryReference object in the given BCT.
     *
     * @param params A map contains:<br>
     *         <ul>
     *           <li>bctId - int, the current BCT instance id</li>
    ...
    public Map deleteCategory(Map params) {
        ...
        try {
            ...
            cstService.deleteCategoryReference(bctId, parentId, categoryId);
            map.put("successful", true);
        } catch(Exception e) {
            e.printStackTrace();
            map.put("reason", e.getMessage());
    ...
    /**
     * Get the valid themes of a bct object
     * 
     * @param params A map contains:<br>
     *         <ul>
     *           <li>bctId - int, the current BCT instance id</li>
    ...
    public Map getThemes(HttpServletRequest request, Map params) {
        ...
        try {
            ...
            if (bct==null) {
                map.put("reason", "bct not exists.");
                return map;
            }
            
            Set refs = bct.getRootCategory().getChildren();
    ...
    public Map saveSummary(Map params) {
        ...
        try {
            ...
            cstService.saveSummary(bctId, themeId, description, summary, tags);
