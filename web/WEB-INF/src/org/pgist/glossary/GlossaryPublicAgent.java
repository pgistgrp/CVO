...
public class GlossaryPublicAgent {
     ...
     *           <li>html - a HTML source segment. (Generated by /WEB-INF/jsp/glossary/gpvTerms.jsp)<br>
    ...
    public Map getTerms(HttpServletRequest request, Map params) {
        ...
        try {
            ...
            map.put("html", WebContextFactory.get().forwardToString("/WEB-INF/jsp/glossary/gpvTerms.jsp"));
     ...
     *           <li>successful - a boolean value denoting if the operation succeeds</li>
     *           <li>reason - reason why operation failed (valid when successful==false)</li>
     *           <li>html - a HTML source segment, generated by /WEB-INF/jsp/glossary/gpvTermView.jsp.
     *                  The following variables are available for use in the jsp:
     *                  <ul>
    ...
    public Map getTermHTML(HttpServletRequest request, Map params) {
        ...
        try {
            ...
            map.put("html", WebContextFactory.get().forwardToString("/WEB-INF/jsp/glossary/gpvTermView.jsp"));
     ...
     *           <li>relatedTerms - string array, each element is the name of a related Term.</li>
     *         </ul>
     */
    public Map getTermObject(Map params) {
        ...
        try {
            ...
            Set relatedTerms = term.getRelatedTerms();
            if (!relatedTerms.isEmpty()) {
                String[] terms = new String[relatedTerms.size()];
                int i=0;
                for (Term one : (Set<Term>) relatedTerms) {
                    terms[i++] = one.getName();
                }
                map.put("relatedTerms", terms);
            }
