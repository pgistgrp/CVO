...
public class FundingAgent {
    ...
    /**
     * Get the estimate for user commute in tax calculator.
     * 
     * @param params a Map contains:<br>
     *   <ul>
     *     <li>cctId - int, id of the current CCT object</li>
     *     <li>tollIds - string, comma separated ids of tolls (FundingSourceAlternative object)</li>
     ...
     *           <li>userCommute - a UserCommute objects</li>
     *         </ul>
     *     </li>
     *   </ul>
     */
    public Map getEstimates(Map params) {
        Map map = new HashMap();
        map.put("successful", false);
     ...
     *   <ul>
     *     <li>cctId - int, id of the current CCT object</li>
     *     <li>tolls - string, comma separated id:value pairs of tolls (id is for FundingSourceAlternative object)</li>
     *     <li>zip - string, zip code of the current user</li>
     *     <li>driveDays - int, number of days user drives to work</li>
     *     <li>carpoolDays - int, number of days user carpools to work</li>
     *     <li>busDays - int, number of days user takes the bus to work</li>
     ...
     *         <ul>
     *           <li>sources - a list of FundingSource objects</li>
