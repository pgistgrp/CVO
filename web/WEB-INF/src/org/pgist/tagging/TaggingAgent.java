...
public class TaggingAgent {
     ...
     *           <li>html - a HTML source segment. (Generated by /WEB-INF/jsp/tagging/stopWords.jsp)<br>
     *                  The following variables are available for use in the jsp, stored in request:
     *                  <ul>
     *                    <li>stopWords - A list of Tag object.</li> 
    ...
    /**
     * Create a stopWord in a JSP, taggingService stores it into the database. No
     * duplicate allowed.
     * @param params A Map contains: <br>
     *         <ul>
    ...
    public Map createStopWord(Map params) {
        ...
        try {
            Tag stopWord = taggingService.createTag(name, false);
            map.put("successful", true);
        } catch (Exception e) {
            e.printStackTrace();
            map.put("reason", e.getMessage());
    ...
    public Map deleteStopWord(Map params) {
        ...
        try {
            taggingService.deleteTag(id, false);
            map.put("successful", true);
        } catch (Exception e) {
            e.printStackTrace();
            map.put("reason", e.getMessage());
     ...
     *         <ul>
     *           <li>successful - a boolean value denoting if the operation succeeds</li>
     *           <li>stopWords - a list of Tag objects.
     *           <li>reason - reason why operation failed (valid when successful==false)</li>
     *         </ul>
     */
    public Map searchStopWords(Map params) {
        ...
        try {
            Collection stopWords = taggingService.searchTags(name, false);
     ...
     *         <ul>
     *           <li>successful - a boolean value denoting if the operation succeeds</li>
     *           <li>html - a HTML source segment. (Generated by /WEB-INF/jsp/tagging/tags.jsp)<br>
     *                  The following variables are available for use in the jsp, stored in request:
     *                  <ul>
    ...
    public Map createTag(Map params) {
        ...
        try {
            Tag tag = taggingService.createTag(name, true);
            map.put("tag", tag);
            map.put("successful", true);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public Map deleteTag(Map params) {
        ...
        try {
            ...
            taggingService.deleteTag(id, true);
            map.put("successful", true);
        } catch (Exception e) {
            e.printStackTrace();
            map.put("reason", e.getMessage());
    ...
    public Map searchTags(Map params) {
        ...
        try {
            Collection tags = taggingService.searchTags(name, true);
