...
<body>
	...
	<div id="text">
		...
		<h1><strong>Voicing Climate Concerns</strong> is an experiment in participatory democracy. <a href="/lmMenu.do?workflowId=&contextId=&activityId=&" title="Learn more about this study">Learn more</a> about this research study or <b><a href="register.do">register now</a></b>. Your browser must use Firefox to access the experiment. Download <a href="http://www.mozilla.com/en-US/firefox/all.html"title="Download Firefox">here</a></h1>
