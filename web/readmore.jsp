...
<html:html>
<html><head><title>Let's Improve Transportation!: Read More</title><!-- Site Wide CSS -->
...
<div id="cont-main">
  <h3><strong><a name="step1">Step 1: Discuss Concerns</a></strong></h3>
  ...
  <h3><a name="step2">Step 2: Review Criteria</a></h3>
  ...
  <ul>
    <li><strong>2b: Weigh Criteria
      </strong>
      <ul>
        <li>
         
        Participants individually choose their favorite  criteria and weigh the relative importance of these criteria for project evaluation. </li>
      </ul>
    </li>
  </ul>
  <h3><a name="step3">Step 3: Create Packages</a></h3>
  ...
  <ul>
    <li><strong>Step 3b: Select Funding Options</strong><br />Here you can read about available funding sources and express their preferences for how funds should be raised to fund a transportation improvment project.
      <ul>
  ...
  <ul>
    <li><strong>Step 3c: Create Personal Transportation Package</strong><br />Based on the your prefered criteria weights and prefered funding options, a suggested transportation improvment package is displayed. Here you can revise this suggested package to create your own personal transportation package.</li>
  </ul>
  <h3><a name="step4">Step 4: Evaluate Packages</a></h3>
  ...
  <ul>
    ...
    <li><strong>4b: Compare Packages
      ...
      <ul>
        ...
        Participants discuss whether or not they wish to  collectively endorse the top-ranked package.</li>
  ...
  <h3><a name="step5">Step 5: Prepare Group Report</a></h3>
  ...
  <ul>
    ...
    Participants  review and discuss this draft report and submit their comments and suggested  revisions.</li>
    <li>
     
    The  moderator makes revisions and includes participant comments when appropriate.</li>
    <li>
     
    Participants  review the final report.</li>
