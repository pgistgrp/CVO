...
<html>
<head>
<title>Let's Improve Transportation!: Read More</title>
<!-- Site Wide CSS -->
<!-- Site Wide CSS -->
...
<!-- Sub Title -->
<div id="subheader">
  <h1>Let's Improve Transportation:</h1>
  <h2>Decision Process</h2>
</div>
<div id="footprints"> <span class="smalltext"><a href="main.do">Participate</a> » Read More </div>
<!-- End Sub Title -->
<!-- Overview SpiffyBox -->
<div class="cssbox">
...
<div id="cont-main">
  <div id="readmore">
    <h3><a name="step1" class="blue">Step 1: Discuss Concerns</a></h3>
    ...
    <h3><a name="step2" class="blue">Step 2: Review Criteria</a></h3>
    ...
    <h3><a name="step3" class="blue">Step 3: Create Packages</a></h3>
    ...
    <h3><a name="step4" class="blue">Step 4: Evaluate Packages</a></h3>
    ...
    <h3><a name="step5" class="blue">Step 5: Prepare Group Report</a></h3>
