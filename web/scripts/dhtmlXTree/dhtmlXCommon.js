...
function dhtmlDragAndDropObject(){
	...
	dhtmlDragAndDropObject.prototype.callDrag=function(e){
		...
		if (dragger.dragNode.parentNode!=document.body){
			...
			dragger.dragNode.style.left=e.clientX+15+(dragger.fx?dragger.fx*(-1):0)+document.body.scrollLeft;  
			dragger.dragNode.style.top=e.clientY+3+(dragger.fy?(-1)*dragger.fy:0)+document.body.scrollTop; 
	...
	dhtmlDragAndDropObject.prototype.checkLanding=function(htmlObject,x,y){ 
		if (htmlObject.dragLanding) { if (this.lastLanding) this.lastLanding.dragLanding._dragOut(this.lastLanding);
			 ...
			 if (htmlObject.tagName!="BODY") this.checkLanding(htmlObject.parentNode,x,y);
	...
	dhtmlDragAndDropObject.prototype.stopDrag=function(e,mode){
        ...
        dragger.lastLanding=null;
		if (dragger.dragNode.parentNode==document.body) dragger.dragNode.parentNode.removeChild(dragger.dragNode);
		dragger.dragNode=0;
