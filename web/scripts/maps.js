...
var PGISTMap = function(mapdiv) {
	...
	if (GBrowserIsCompatible()) {
		...
		pgicon.image = "http://localhost:8080/images/ltr_2.png";
		this.bubbleicons['ltr_1'] = pgicon;
	
		pgicon = new GIcon(pgicon); 
		pgicon.image = "http://localhost:8080/images/ltr_3.png";
		this.bubbleicons['ltr_2'] = pgicon;
	
		pgicon = new GIcon(pgicon); 
		pgicon.image = "http://localhost:8080/images/ltr_4.png";
		this.bubbleicons['ltr_3'] = pgicon;
	
		pgicon = new GIcon(pgicon); 
		pgicon.image = "http://localhost:8080/images/ltr_5.png";
		this.bubbleicons['ltr_4'] = pgicon;
...
*/								
								...
								if(this.projectClickHandler) infoHTML += '<a href="javascript:' 
									+ this.projectClickHandler + '(' + project.id + ');">Read more and discuss this project</a>';
