...
Date.prototype.toDashedString = function(){ // creates MM-DD-YYYY pattern
  str = (this.getMonth() + 1) + "-" + this.getDate() + "-" + this.getFullYear();
  return str;
}
Date.parseDashedString = function(string) {    //converts dashed date to date object
    a = string.split("-");    
...
CalendarDateSelect.prototype = {
  ...
  dateString: function() {
    ...
    return (this.selection_made) ? this.selected_date.toDashedString() : "&nbsp;";
  },
  ...
  parseDate: function()
  {
    ...
    this.date = Date.parseDashedString(this.options['date'] || $F(this.target_element));
